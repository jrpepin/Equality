...
/* 
* division_of_labor
In your life, how have you already planned around work and family? 
Please choose the answer option that best fits your life.
...
/* NOT USED BUT KEEPING CODE IN CASE CHANGE MIND
cap drop agecat
gen agecat=.
...
replace married=0 if marstat!=1 & marstat != 6
tab married marstat
...
/* NOT USING BECAUSE OF MISSING DATA...
*FAMILY INCOME
fre faminc_new
